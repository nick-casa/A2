...
/*   Compares the two lexicographically. Returns 1 if compA is 		  */
/*   greater than compB, -1 if compA is less than compB, and if the   */
/*   two strings are equal.               						      */
/*--------------------------------------------------------------------*/
int Str_compare(const char *compA, const char *compB);

/*--------------------------------------------------------------------*/
/*   Function takes in two strings, a needle and a haystack.          */
/*   If the needle is of length zero, the haystack is returned.  	  */
/*   However, if the needle is if of length one or greater, the       */
/*   reference to the first char of a substring that matches needle   */
/*   is returned. Finally, if the needle is not in the haystack,      */
/*	 NULL is returned.								         		  */
/*--------------------------------------------------------------------*/
